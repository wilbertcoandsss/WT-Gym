...
import edu.bluejack23_1.wtgym.databinding.FragmentInsertExerciseBinding
 ...
 * Use the [InsertExerciseFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class InsertExerciseFragment : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private var isMediaManagerInitialized = false

    private lateinit var binding: FragmentInsertExerciseBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentInsertExerciseBinding.inflate(inflater, container, false)
                    ...
                    MediaManager.get().upload(uri)
                        .callback(object : UploadCallback {
                            ...
                            override fun onSuccess(requestId: String, resultData: Map<*, *>) {
                                ...
                                val newExerciseRef: Task<DocumentReference> =
                                    exercisesCollection.add(exerciseData)

                                Log.d("Exercise", param1.toString())
//

                                val snackbar = Snackbar.make(
                                    requireView(),
                                    "Successfully Inserted Exercises",
                                    Snackbar.LENGTH_SHORT
                                )
    ...
    companion object {
         ...
         * @return A new instance of fragment InsertExerciseFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String) =
            InsertExerciseFragment().apply {
